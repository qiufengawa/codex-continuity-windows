...
Codex Continuity for Windows 是一个原生 Windows GUI 工具，用来解决频繁切换 Codex CLI API Provider 后，本地历史会话难以继续 `codex resume` 的问题。
...
App 会读取本地 Codex JSONL 日志。只有当你明确点击 **Sync to Current Provider** 或导出恢复文件时才会写文件。
